...
1. **Criação de Pedidos Médicos:**  
   O sistema deve permitir que médicos criem pedidos médicos de exames clínicos com informações como tipo de exame, data, observações e número de protocolo do paciente.

2. **Armazenamento de Pedidos Médicos:**  
   O sistema deve armazenar os pedidos médicos em um banco de dados, associando-os ao número de protocolo do paciente.
